		...
		subscribe: function(){
			$(".picman_tm_subscribe a").on('click', function(){
				...
				if(PicmanInit.validateEmail(email)){
					$.post("modal/subscribe.html",{ ajax_email: email, ajax_message: message}, function(data) {
		...
		contactForm: function(){
			jQuery(".contact_form #send_message").on('click', function(){
				...
				if(name===''||email===''||message===''){
					...
					jQuery.post("modal/contact.html",{ ajax_name: name, ajax_email: email, ajax_phone: phone, ajax_message:message}, function(data) {
